  ...
  return (
    ...
    >
      <div className="w-full max-w-md">
        {/* Fondo blanco transparente - CORREGIDO */}
        <div 
          className="rounded-2xl shadow-xl p-6 md:p-8"
          style={{
            backgroundColor: 'rgba(255, 255, 255, 0.3)', // Blanco con 80% de opacidad
            backdropFilter: 'blur(4px)' // Efecto de desenfoque suave
          }}
        >
          ...
          <div className="space-y-3 mb-6">
            <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition duration-200">
